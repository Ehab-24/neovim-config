...
-- keymaps for quickfix and location list
...
vim.keymap.set('n', '<leader>f', "/\\<<C-r><C-w>\\>/g<Left><Left><Enter>")
...
vim.keymap.set('n', '<leader>sv', vim.cmd.Ex, { desc = "Open default file tree" })
